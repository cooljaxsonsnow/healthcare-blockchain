              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <Link to={"/dashboard"}>
                      <div className="flex items-center">
                        <div className="text-black ml-5 font-semibold text-lg">
                          Healthcare Records
                        </div>
                      </div>
                    </Link>
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      {!authService.getCurrentUser() && (
                        <>
                          <button
                            className="bg-secondary hover:bg-secondary-dark text-white font-bold py-2 px-5 rounded-full"
                            onClick={() => navigate("/login")}
                          >
                            Login
                          </button>
                          <button
                            className="bg-primary hover:bg-primary-light text-white font-bold py-2 px-5 rounded-full ml-4"
