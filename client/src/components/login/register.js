  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await registerService.registerPatient({
        args: [name, dob, gender, contact, bloodGroup, address],
        fcn: "registerPatient",
        orgName: "patient",
        password,
        username,
        ...
        <div className="flex flex-col items-center justify-center px-6 mx-auto lg:py-0">
          <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full text-white bg-primary hover:bg-primary-light focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
